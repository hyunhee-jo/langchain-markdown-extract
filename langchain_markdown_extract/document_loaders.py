"""LangChain Document Loader for markdown-extract."""
...
from markdown_extract import extract as _extract

logger = logging.getLogger(__name__)


class MarkdownExtractLoader(BaseLoader):
    """Load Markdown files using markdown-extract and return LangChain Documents.

    This loader wraps the markdown-extract library to parse Markdown files
    ...
    def __init__(
        ...
        Args:
            ...
            format: Output format from markdown-extract. Default: "text".
